...
./kernel2minor -k $KERNEL -r ./$RESNAME.nor-tik-yaffs2.bin -s 1024 -i 0 -p NOR -e
#for NAND
./kernel2minor -k $KERNEL -r ./$RESNAME.nand-tik-yaffs2-2048b-ecc.bin -s 2048 -i $CI_BLKSZ -p NAND -c -e
